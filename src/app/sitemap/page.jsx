...
export default function SitemapPage() {
  const links = [
    ...
    { name: 'Apply Now', href: 'https://applynow.hitmranchi.ac.in/?utm_source=website' },
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-x-12 gap-y-4">
          {links.map((l, i) => (
            <Link
              key={i}
              href={l.href}
              className="text-lg text-gray-600 hover:text-hitm-red flex items-center gap-3 py-2 border-b border-gray-50"
            >
