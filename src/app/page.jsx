...
const heroSlides = [
  {
    ...
    title: 'Top Technical Institute in Jharkhand',
    subtitle:
...
export default function HomePage() {
  ...
  const marqueeItems = activeNotices.length > 0 ? activeNotices : ['📣 Admissions Open for 2026–27 Batch '];
  ...
  return (
    <main>
      ...
      <Link
        href="/career"
        className="block bg-hitm-red py-2.5 overflow-hidden hover:bg-hitm-navy transition-colors cursor-pointer"
      >
              ...
              <form onSubmit={handleEnquiry} className="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div className="space-y-1 md:col-span-2">
                  ...
                  <select
                    ...
                    onChange={(e) => setEnquiry({ ...enquiry, program: e.target.value })}
                  >
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            <div className="relative">
              ...
              <Card className="absolute -bottom-5 -right-5 shadow-xl bg-hitm-red text-white border-none">
                <CardContent className="p-4 text-center">
                  ...
                  <div className="text-xs text-white/75 mt-1">Established On</div>
                </CardContent>
              </Card>
            </div>
            ...
            <div>
              ...
              <p className="text-gray-600 leading-relaxed mb-4">
                Haider Institute of Technology and Management (HITM Ranchi) is redefining the educational landscape of
                Jharkhand as a future-focused institution dedicated to excellence in Engineering, Management, and
                Technology.
              </p>
              <p className="text-gray-600 leading-relaxed mb-8">
                Our mission is to empower students with cutting-edge skills, global industry exposure, and a spirit of
                innovation that prepares them for the challenges of tomorrow.
              </p>
        ...
        <div className="container mx-auto px-4">
          <div className="section-title mb-16">
            ...
            <p className="text-gray-500 mt-4 max-w-2xl mx-auto text-lg leading-relaxed">
              Choose from our industry-aligned technical and management programmes designed to launch your global
              career.
            </p>
            <Badge variant="outline" className="mt-2 border-hitm-red text-hitm-red font-bold px-4 py-1">
              Academic Programmes
            </Badge>
          </div>
                  ...
                  {events.map((e, i) => (
                    ...
                    >
                      ...
                      <div className="flex-1 flex flex-col">
                        ...
                        <p className="text-[11px] text-gray-600 mt-1 leading-snug">{e.title}</p>
                      </div>
                      <Badge variant="secondary" className="text-[9px] bg-hitm-navy/5 text-hitm-navy self-start">
                        Join
                      </Badge>
                    </div>
                  ))}
        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="section-title">
            ...
            <p className="text-gray-400 mt-4 max-w-2xl mx-auto">
              Experience a vibrant ecosystem designed for holistic growth, innovation, and lifelong friendships.
            </p>
          </div>
          <div className="grid grid-cols-2 lg:grid-cols-4 grid-rows-2 gap-4 h-[500px] md:h-[600px]">
            {[
              ...
              {
                label: 'Sports Arena',
                image: 'https://images.unsplash.com/photo-1517649763962-0c623066013b?auto=format&fit=crop&q=80&w=900',
              },
              {
            ...
            <div>
              ...
              <div className="mt-6 space-y-5 text-gray-600 text-base leading-8">
                <p>
                  ...
                  delivering quality education in engineering, technology, and management. Located in Ranchi, Jharkhand,
                  the institute is established with the vision of nurturing skilled professionals, innovative thinkers,
                  and responsible leaders for a rapidly evolving global environment.
                </p>
                <p>
                  The institute offers industry-oriented programs with a modern curriculum, practical learning approach,
                  and strong academic foundation. With experienced faculty, state-of-the-art infrastructure, and a
                  student-centric learning environment, Haider Institute of Technology and Management focuses on
                  academic excellence, skill development, and overall personality growth.
                </p>
                <p>
            ...
            <div className="grid gap-4">
              <div className="rounded-3xl bg-gradient-to-br from-hitm-navy to-hitm-red p-8 text-white shadow-2xl">
                ...
                <p className="mt-4 text-white/85 leading-7">
                  Modern curriculum, practical learning, and industry interaction come together to shape confident and
                  capable future professionals.
                </p>
              </div>
              ...
              <div className="grid sm:grid-cols-2 lg:grid-cols-1 gap-4">
                <div className="rounded-2xl border border-gray-200 bg-gray-50 p-6">
                  ...
                  <p className="mt-3 text-gray-700 leading-7">
                    To nurture innovative thinkers, skilled professionals, and responsible leaders for a changing global
                    environment.
                  </p>
                </div>
