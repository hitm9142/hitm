      ...
      <section className="bg-hitm-navy pt-32 pb-20 relative overflow-hidden">
        ...
        <div className="container mx-auto px-4 relative z-10 text-center">
          ...
          <p className="text-gray-400 max-w-2xl mx-auto text-lg leading-relaxed">
            Join a vibrant community of educators, researchers, and innovators dedicated to shaping the leaders of
            tomorrow.
          </p>
        </div>
      </section>
        ...
        <div className="container mx-auto px-4">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-20">
            {[
              {
                icon: <Users size={32} />,
                title: 'Incredible Culture',
                desc: 'Collaborate with industry veterans and passionate educators in a supportive environment.',
              },
              {
                icon: <GraduationCap size={32} />,
                title: 'Growth & Research',
                desc: 'Ample opportunities for research funding, Ph.D. support, and professional certifications.',
              },
              {
                icon: <CheckCircle size={32} />,
                title: 'Premium Benefits',
                desc: 'Competitive salary packages, health insurance, and campus-wide facilities for employees.',
              },
            ].map((f, i) => (
              <div
                key={i}
                className="text-center p-8 rounded-3xl bg-gray-50 hover:bg-white hover:shadow-2xl transition-all border border-gray-100"
              >
            ...
            {categorizedJobs.length === 0 ? (
              <div className="text-center py-12 bg-gray-50 rounded-3xl border border-gray-100">
                ...
                <p className="text-sm text-gray-500">
                  We are not actively hiring at this moment, but you can always drop a general application.
                </p>
              </div>
            ) : (
                          ...
                          <div className="flex flex-col md:flex-row md:items-center justify-between gap-6">
                            <div>
                              <div className="flex items-center gap-2 mb-2">
                                <Badge variant="secondary" className="bg-hitm-red/10 text-hitm-red border-none">
                            ...
                            <Button
                              ...
                              variant="default"
                              className="bg-hitm-navy hover:bg-hitm-red shadow-lg"
                            >
          ...
          <div className="mt-20 bg-gray-950 rounded-[40px] p-8 md:p-16 text-center text-white relative overflow-hidden">
            ...
            <h2 className="text-3xl md:text-4xl font-black font-serif mb-6 relative z-10">
              Don&apos;t see a matching role?
            </h2>
            <p className="text-white/60 mb-8 max-w-xl mx-auto relative z-10">
              Send your resume to <span className="text-hitm-gold font-bold">info@hitmranchi.ac.in</span>. We&apos;ll
              keep you in our talent pool for future opportunities.
            </p>
            <Button
              variant="gold"
              size="lg"
              className="relative z-10 shadow-2xl"
              onClick={() => setApplyModal({ id: 'general', title: 'General Application' })}
            >
              ...
              <form onSubmit={handleApply} className="space-y-6">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div className="space-y-2 md:col-span-2">
                    ...
                    <Input
                      disabled
                      value={applyModal.title}
                      className="bg-gray-50 font-bold text-hitm-navy border-gray-200 cursor-not-allowed opacity-80"
                    />
                  </div>
                ...
                <div className="flex gap-4 pt-4 sticky bottom-0 bg-white">
                  {submitting ? (
                    <div className="w-full flex flex-col items-center justify-center gap-1 bg-hitm-navy text-white rounded-xl py-3 text-sm font-bold animate-pulse">
                      ...
                      {careerUploadStatus && (
                        <span className="text-[11px] text-hitm-gold font-normal tracking-wide">
                          {careerUploadStatus}
                        </span>
                      )}
                    </div>
                    ...
                    <>
                      ...
                      <Button
                        ...
                        className="flex-1 bg-hitm-red hover:bg-hitm-navy font-bold h-12 rounded-xl"
                      >
                        Submit Application
                      </Button>
                    </>
